...
export function renderApplicationPdf(app) {
  return new Promise((resolve, reject) => {
    ...
    row(doc, 'Latest Percentage', app.college?.latestPercentage)
    row(doc, 'Backlogs', app.college?.backlogs)
    ...
    row(doc, 'Medium of Instruction', app.medium)
    row(doc, 'Tamil Medium till 12th', app.tamilMediumTill12)
    ...
    docRow(doc, 'Educational Certificates', Boolean(app.educationalCertificatesUrl))
    ...
    docRow(doc, 'SC/ST/SC(A) Community Certificate', Boolean(app.communityCertificateUrl))
